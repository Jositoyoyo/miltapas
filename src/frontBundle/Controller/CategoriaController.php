...
use frontBundle\Entity\Categoria;
use frontBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categorias = $em->getRepository('frontBundle:Categoria')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('frontBundle\Form\CategoriaType', $categorium);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorium);
        $editForm = $this->createForm('frontBundle\Form\CategoriaType', $categorium);
