...
use miltapasBundle\Entity\Categoria;
use miltapasBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categorias = $em->getRepository('miltapasBundle:Categoria')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('miltapasBundle\Form\CategoriaType', $categorium);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorium);
        $editForm = $this->createForm('miltapasBundle\Form\CategoriaType', $categorium);
